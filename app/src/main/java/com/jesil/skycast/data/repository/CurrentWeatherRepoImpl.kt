...
//            .map {
//            when (it) {
//                is Response.Error -> Response.Error(it.errorMessage)
...
//                }
//
//                current is Response.Error -> Response.Error(current.errorMessage)
//                hourly is Response.Error -> Response.Error(hourly.errorMessage)
...
//    }.flowOn(Dispatchers.IO)
    override suspend fun fetchCurrentWeather(
        ...
        weatherRemoteDataSource.fetchCurrentWeather(
            latitude = latitude,
            longitude = longitude
        ).map {
            it.toCurrentDailyWeather()
        }.flowOn(Dispatchers.IO)
