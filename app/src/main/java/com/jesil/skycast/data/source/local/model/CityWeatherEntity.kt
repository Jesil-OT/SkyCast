...
//    @ColumnInfo(name = "daily_weather") val dailyWeather: List<CityWeatherEntity> = emptyList()

)

//class Converters {
//    @TypeConverter
//    fun fromHourlyWeatherList(value: List<CityWeatherEntity>?): String {
//        return if (value == null) "" else Json.encodeToString(value)    }
//
//    @TypeConverter
//    fun toHourlyWeatherList(value: String): List<CityWeatherEntity>? {
//        return if (value.isEmpty()) emptyList() else Json.decodeFromString(value)
//    }
//
//    @TypeConverter
//    fun fromDailyWeatherList(value: List<CityWeatherEntity>?): String {
//        return if (value == null) "" else Json.encodeToString(value)
//    }
//
//    @TypeConverter
//    fun toDailyWeatherList(value: String): List<CityWeatherEntity>? {
//        return if (value.isEmpty()) emptyList() else Json.decodeFromString(value)
//    }
//}
