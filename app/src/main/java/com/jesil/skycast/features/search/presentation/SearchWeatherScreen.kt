...
//                            popUpTo(Screens.WeatherScreen.route){
//                                inclusive = true
//                            }
                        }
                    },
...
fun SearchWeatherInnerScreen(
    ...
    BottomSheetScaffold(
        ...
        sheetPeekHeight = 64.dp, // how much is visible when collapsed
                ...
                Surface(
                    ...
                    Column {
                        ...
                        HorizontalDivider(
                            ...
                            thickness = 1.dp,
                            color = androidx.compose.ui.graphics.Color.White.copy(.2f)
                        )
